...
class NetworkPreferences(
    ...
    // SY -->
    fun enableFlareSolverr() = preferenceStore.getBoolean("flare_solverr_enabled", false)

    fun flareSolverrUrl() = preferenceStore.getString("flare_solverr_url", "http://127.0.0.1:8191")
    // SY <--
}